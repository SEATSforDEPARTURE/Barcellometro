...
from app.features.activity.services.daily_activity_report import build_combined_activity_inactive_txt
...
def test_daily_report_view_buttons_order_timeout_and_custom_ids_are_present() -> None:
    report_source = Path("app/features/activity/services/daily_activity_report.py").read_text()
