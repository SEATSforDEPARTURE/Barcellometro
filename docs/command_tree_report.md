...
| `campagne` | `prompt` | `off` | Disable prompt campaigns in the current channel | `app/plugins/commands_modular/triggers.py:630` |
| `campagne` | `prompt` | `on` | Enable prompt campaigns in the current channel | `app/plugins/commands_modular/triggers.py:618` |
| `campagne` | `prompt` | `run` | Run a prompt campaign schedule now | `app/plugins/commands_modular/triggers.py:763` |
| `campagne` | `prompt` | `schedule_add` | Add a prompt campaign schedule | `app/plugins/commands_modular/triggers.py:661` |
| `campagne` | `prompt` | `schedule_edit` | Edit a prompt campaign schedule | `app/plugins/commands_modular/triggers.py:807` |
| `campagne` | `prompt` | `schedule_list` | List prompt campaign schedules | `app/plugins/commands_modular/triggers.py:720` |
| `campagne` | `prompt` | `schedule_remove` | Remove a prompt campaign schedule | `app/plugins/commands_modular/triggers.py:748` |
| `campagne` | `prompt` | `schedule_show` | Show a prompt campaign schedule | `app/plugins/commands_modular/triggers.py:734` |
| `campagne` | `prompt` | `status` | Show prompt campaign status for the current channel | `app/plugins/commands_modular/triggers.py:642` |
...
| `frasi` | `—` | `entry_add` | Add a phrase trigger entry | `app/plugins/commands_modular/triggers.py:307` |
| `frasi` | `—` | `entry_edit` | Edit a phrase trigger entry | `app/plugins/commands_modular/triggers.py:416` |
| `frasi` | `—` | `entry_list` | List phrase trigger entries | `app/plugins/commands_modular/triggers.py:362` |
| `frasi` | `—` | `entry_remove` | Remove a phrase trigger entry | `app/plugins/commands_modular/triggers.py:349` |
| `frasi` | `—` | `entry_show` | Show a phrase trigger entry | `app/plugins/commands_modular/triggers.py:375` |
| `frasi` | `—` | `off` | Disable phrase triggers | `app/plugins/commands_modular/triggers.py:291` |
| `frasi` | `—` | `on` | Enable phrase triggers | `app/plugins/commands_modular/triggers.py:287` |
| `frasi` | `—` | `status` | Show phrase trigger status | `app/plugins/commands_modular/triggers.py:295` |
| `frasi` | `—` | `template_global_reset` | Reset the global phrase template | `app/plugins/commands_modular/triggers.py:559` |
| `frasi` | `—` | `template_global_set` | Set the global phrase template | `app/plugins/commands_modular/triggers.py:532` |
| `frasi` | `—` | `template_global_show` | Show the global phrase template | `app/plugins/commands_modular/triggers.py:546` |
| `frasi` | `—` | `template_milestone_reset` | Reset all milestone templates | `app/plugins/commands_modular/triggers.py:519` |
| `frasi` | `—` | `template_milestone_set` | Create or update a milestone template | `app/plugins/commands_modular/triggers.py:489` |
| `frasi` | `—` | `template_milestone_show` | Show milestone templates | `app/plugins/commands_modular/triggers.py:506` |
| `frasi` | `—` | `template_user_reset` | Reset a user-specific phrase template | `app/plugins/commands_modular/triggers.py:607` |
| `frasi` | `—` | `template_user_set` | Set a user-specific phrase template | `app/plugins/commands_modular/triggers.py:577` |
| `frasi` | `—` | `template_user_show` | Show a user-specific phrase template | `app/plugins/commands_modular/triggers.py:594` |
...
| `insights` | `—` | `off` | Disable insights in the current channel | `app/plugins/commands_modular/triggers.py:989` |
| `insights` | `—` | `on` | Enable insights in the current channel | `app/plugins/commands_modular/triggers.py:985` |
| `insights` | `—` | `status` | Show insights status for the current channel | `app/plugins/commands_modular/triggers.py:993` |
| `insights` | `—` | `template_reset` | Reset the insights template to defaults | `app/plugins/commands_modular/triggers.py:1029` |
| `insights` | `—` | `template_set` | Set the insights template | `app/plugins/commands_modular/triggers.py:1007` |
| `insights` | `—` | `template_show` | Show the insights template | `app/plugins/commands_modular/triggers.py:1017` |
...
| `qna` | `—` | `bonus_reset` | Reset a user's QnA bonus | `app/plugins/commands_modular/triggers.py:975` |
| `qna` | `—` | `bonus_set` | Set a QnA bonus for a user | `app/plugins/commands_modular/triggers.py:944` |
| `qna` | `—` | `bonus_show` | Show a user's QnA bonus | `app/plugins/commands_modular/triggers.py:964` |
| `qna` | `—` | `limits_reset` | Reset QnA daily limits to defaults | `app/plugins/commands_modular/triggers.py:934` |
| `qna` | `—` | `limits_set` | Set a QnA daily limit | `app/plugins/commands_modular/triggers.py:913` |
| `qna` | `—` | `limits_show` | Show QnA daily limits | `app/plugins/commands_modular/triggers.py:889` |
| `qna` | `—` | `off` | Disable QnA in the current channel | `app/plugins/commands_modular/triggers.py:879` |
| `qna` | `—` | `on` | Enable QnA in the current channel | `app/plugins/commands_modular/triggers.py:875` |
| `qna` | `—` | `status` | Show QnA status for the current channel | `app/plugins/commands_modular/triggers.py:883` |
...
- **WARNING required_param** — `campagne.prompt.schedule_show`: Parameter 'id_or_name' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:734`)
...
- **WARNING required_param** — `frasi.template_global_set`: Parameter 'text' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:532`)
- **WARNING required_param** — `frasi.template_milestone_set`: Parameter 'threshold' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:489`)
- **WARNING required_param** — `frasi.template_milestone_set`: Parameter 'text' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:489`)
- **WARNING required_param** — `frasi.template_user_set`: Parameter 'text' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:577`)
...
- **WARNING required_param** — `insights.template_set`: Parameter 'text' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:1007`)
...
- **WARNING required_param** — `qna.bonus_set`: Parameter 'amount' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:944`)
- **WARNING required_param** — `qna.limits_set`: Parameter 'tier' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:913`)
- **WARNING required_param** — `qna.limits_set`: Parameter 'limit' is required in a configuration-style command; verify it is indispensable. (`app/plugins/commands_modular/triggers.py:913`)

## Legacy alias review

- **WARNING legacy_alias** — `app/plugins/commands_modular/roles.py`: `if not await check_permission(interaction, "bm.commandguard.role_add", ctx, legacy_aliases=["bm.role.set_role"]):` (`app/plugins/commands_modular/roles.py:49`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/roles.py`: `if not await check_permission(interaction, "bm.commandguard.role_edit", ctx, legacy_aliases=["bm.role.set_role"]):` (`app/plugins/commands_modular/roles.py:59`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/roles.py`: `if not await check_permission(interaction, "bm.commandguard.user_add", ctx, legacy_aliases=["bm.role.set_user"]):` (`app/plugins/commands_modular/roles.py:108`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/roles.py`: `if not await check_permission(interaction, "bm.commandguard.user_edit", ctx, legacy_aliases=["bm.role.set_user"]):` (`app/plugins/commands_modular/roles.py:118`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.add")` (`app/plugins/commands_modular/triggers.py:315`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.remove")` (`app/plugins/commands_modular/triggers.py:350`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.list")` (`app/plugins/commands_modular/triggers.py:363`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.milestone_global_set")` (`app/plugins/commands_modular/triggers.py:490`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.milestone_global_list", "frasi.milestone_global_status")` (`app/plugins/commands_modular/triggers.py:507`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.milestone_global_remove")` (`app/plugins/commands_modular/triggers.py:520`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.template_set")` (`app/plugins/commands_modular/triggers.py:533`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.template_show")` (`app/plugins/commands_modular/triggers.py:547`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.template_reset")` (`app/plugins/commands_modular/triggers.py:560`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.userphrase_set")` (`app/plugins/commands_modular/triggers.py:578`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.userphrase_show")` (`app/plugins/commands_modular/triggers.py:595`)
- **WARNING legacy_alias** — `app/plugins/commands_modular/triggers.py`: `scope = await _require_channel(interaction, "frasi.userphrase_remove")` (`app/plugins/commands_modular/triggers.py:608`)
